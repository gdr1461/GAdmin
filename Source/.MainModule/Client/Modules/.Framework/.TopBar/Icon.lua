...
export type ModuleType = {
	new: () -> IconType,
	getIcons: () -> {IconType},
	getIconByUID: (UID: number) -> IconType,
	getIcon: (nameOrUID: string | number) -> IconType,
...
export type IconType = {
	setName: (self: IconType, Name: string) -> IconType,
	setState: (self: IconType, incomingStateName: string, fromSource: any, sourceIcon: any) -> IconType,
	getInstance: (self: IconType, Name: string) -> GuiObject,
	getCollective: (self: IconType, Name: string) -> {GuiObject},
	getInstanceOrCollective: (self: IconType, Name: string) -> GuiObject | {GuiObject},
	getStateGroup: (self: IconType, iconState: any) -> {any},
	refreshAppearance: (self: IconType, instance: any, specificProperty: any) -> IconType,
	refresh: (self: IconType) -> IconType,
	updateParent: (self: IconType) -> IconType,
	setBehaviour: (self: IconType, collectiveOrInstanceName: string, property: string, callback: any, refreshAppearance: any) -> IconType,
	modifyTheme: (self: IconType, modifications: {string | number}, modificationUID: any) -> IconType,
	modifyChildTheme: (self: IconType, modifications: {string | number}, modificationUID: any) -> IconType,
	removeModification: (self: IconType, modificationUID: any) -> IconType,
	removeModificationWith: (self: IconType, instanceName: string, property: string, state: any) -> IconType,
	setTheme: (self: IconType, Theme: string) -> IconType,
	setEnabled: (self: IconType, Boolean: boolean) -> IconType,
	select: (self: IconType) -> IconType,
	deselect: (self: IconType) -> IconType,
	notify: (self: IconType, customClearSignal: BindableEvent | RemoteEvent, noticeId: number) -> IconType,
	clearNotices: (self: IconType) -> IconType,
	disableOverlay: (self: IconType, Boolean: boolean) -> IconType,
	setImage: (self: IconType, imageId: string, iconState: string) -> IconType,
	setLabel: (self: IconType, text: string, iconState: string) -> IconType,
	setOrder: (self: IconType, int: number, iconState: string) -> IconType,
	setCornerRadius: (self: IconType, udim: UDim2, iconState: string) -> IconType,
	align: (self: IconType, Direction: "Left" | "Center" | "Right", fromParentIcon: boolean) -> IconType,
	setLeft: (self: IconType) -> IconType,
	setMid: (self: IconType) -> IconType,
	setRight: (self: IconType) -> IconType,
	setWidth: (self: IconType, offsetMinimum: number, iconState: string) -> IconType,
	setImageScale: (self: IconType, number: number, iconState: string) -> IconType,
	setImageRatio: (self: IconType, number: number, iconState: string) -> IconType,
	setTextSize: (self: IconType, number: number, iconState: string) -> IconType,
	setTextFont: (self: IconType, font: Enum.Font, fontWeight: Enum.FontWeight, fontStyle: Enum.FontStyle, iconState: string) -> IconType,
	bindToggleItem: (self: IconType, Object: GuiObject | LayerCollector) -> IconType,
	unbindToggleItem: (self: IconType, Object: GuiObject | LayerCollector) -> IconType,
	bindEvent: (self: IconType, iconEventName: string, eventFunction: (Icon: IconType) -> ()) -> IconType,
	unbindEvent: (self: IconType, iconEventName: string) -> IconType,
	bindToggleKey: (self: IconType, keyCodeEnum: Enum.KeyCode) -> IconType,
	unbindToggleKey: (self: IconType, keyCodeEnum: Enum.KeyCode) -> IconType,
	call: (self: IconType, callback: (Icon: IconType) -> (), Variables: any?) -> IconType,
	addToJanitor: (self: IconType, callback: (Icon: IconType) -> ()) -> IconType,
	lock: (self: IconType) -> IconType,
	unlock: (self: IconType) -> IconType,
	debounce: (self: IconType, seconds: number) -> IconType,
	setCaption: (self: IconType, text: string) -> IconType,
	setCaptionHint: (self: IconType, keyCodeEnum: Enum.KeyCode) -> IconType,
	leave: (self: IconType) -> IconType,
	joinMenu: (self: IconType, parentIcon: IconType) -> IconType,
	setMenu: (self: IconType, arrayOfIcons: {IconType}) -> IconType,
	setFrozenMenu: (self: IconType, arrayOfIcons: {IconType}) -> IconType,
	freezeMenu: (self: IconType) -> IconType,
	getDropdown: (self: IconType) -> IconType,
	joinDropdown: (self: IconType, parentIcon: IconType) -> IconType,
	setDropdown: (self: IconType, arrayOfIcons: {IconType}) -> IconType,
	clipOutside: (self: IconType, instance: GuiObject) -> IconType,
	setIndicator: (self: IconType, keyCode: Enum.KeyCode) -> IconType,
	destroy: (self: IconType) -> (),
}

-- CONSTRUCTOR
function Icon.new(): IconType
	local self = {}
